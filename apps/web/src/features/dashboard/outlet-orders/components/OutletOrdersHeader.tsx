  ...
  return (
    <nav className="fixed z-50 h-20 w-full content-center bg-blue-200 p-3 md:w-[calc(100%-256px)]">
      ...
      <div className="flex justify-evenly gap-2 md:justify-normal">
        {pathname === "/dashboard/outlet-orders/enroute" ? (
          <Link href="/dashboard/outlet-orders/enroute" className={clicked}>
            Enroute
          </Link>
        ) : (
          <Link href="/dashboard/outlet-orders/enroute" className={unclicked}>
            Enroute
          </Link>
        )}
